...
public class sortIt
{
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length < 3)
        {
            ...
            System.out.println("Usage: java sort-it <data_type> <output_file> <input_files...>");
            return;
        }
        ...
        //  Deleting duplicate input file names
        {
            ...
            if (uniqueSetOfNames.contains(outputFileName))
            {
                System.out.printf("You can't use one file \"%s\" for read and write data at the time\n", outputFileName);
                isCorrectParameters = false;
            }
